...
Libreria componenti HTML/CSS vanilla con prefisso BEM `tv-*`. Ogni componente usa i token in [design-system.md](design-system.md). Markup semantico, stati focus/hover, note ARIA.
...
<dl class="tv-brew-card" aria-label="Parametri di preparazione">
  ...
  <div class="tv-brew-card__row">
    ...
    <dd class="tv-brew-card__value">2–3</dd>
  </div>
</dl>
```
